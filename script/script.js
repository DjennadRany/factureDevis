/* =========================================================
  ...
  function bindUI() {
    ...
    // Footer (placeholder)
    [ui.linkLegal, ui.linkPrivacy, ui.linkCookies, ui.linkSupport].forEach(a => {
      a.addEventListener("click", (e) => {
        e.preventDefault();
        alert("Lien placeholder : remplace par tes pages (mentions légales, confidentialité, cookies, support).");
      });
    });
  }
